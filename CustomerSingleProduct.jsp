                            ...
                            <div class="col-sm-6">
                                <div class="product-images">
                                    ...
                                    <div class="product-gallery">
                                        <img src="<c:url value='/resources/img/product-thumb-1.jpg' />" alt="">
                                        <img src="<c:url value='/resources/img/product-thumb-2.jpg' />" alt="">
                                        <img src="<c:url value='/resources/img/product-thumb-3.jpg' />" alt="">
                                    </div>
                                </div>
                            </div>
